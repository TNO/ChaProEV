...
def get_car_trip_probabilities_per_day_type(parameters):
    ...
    trip_probabilities_per_day_type.loc[
        ...
        * leisure_trips_per_weekend
        ...
        'home', 'weekend_holiday_departures'
    ]
